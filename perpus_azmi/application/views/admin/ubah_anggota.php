        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="card shadow">
              ...
              <div class="card-body">
                <form method="POST" action="<?= base_url('Admin/action_ubah_anggota') ?>" enctype="multipart/form-data">
                  <div class="row">
                      <div class="form-group col-6">
                        <label>ID Anggota</label>
                        <input type="hidden" name="id_anggota" disabled="" autocomplete="off" class="form-control">
                        <input type="text"   disabled="" value="<?= $read[0]->id_anggota ?>" autocomplete="off" class="form-control">
                      </div>
                      <div class="form-group col-6">
                        <label>Nama</label>
                        <input type="text" name="nama"  required="required" value="<?= $read[0]->nama ?>" placeholder="ketik" autocomplete="off" class="form-control">
                      </div>
                    </div>
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-12">
                        <label>Alamat</label>
                        <input type="text" name="alamat"  required="required" value="<?= $read[0]->alamat ?>" placeholder="ketik" autocomplete="off" class="form-control">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-12">
